...
<html>
<head>
<!-- /Style/Generic2/NoMenuTopLeft.jsp -->
<title><%=title%></title>
...
<table class="LUTableTopLeftSide2" cellpadding="0" cellspacing="0">
	<tbody>
		<tr>
			<td class="Col-Generic2NArea1"><looknFeelArea:looknFeelArea area="Generic2NArea1" /></td>
			<td class="Col-Generic2NArea2"><looknFeelArea:looknFeelArea area="Generic2NArea2" /></td>
			<td class="Col-Generic2NArea3"><looknFeelArea:looknFeelArea area="Generic2NArea3" /></td>
		</tr>
	</tbody>
</table>
...
<tbody>
<tr>
  <td class="LeftSide2 Col-Generic2NArea7">
    <looknFeelArea:looknFeelArea area="Generic2NArea7" />
  </td>
  <td class="MainPage2">
    <table class="LUMainPageTable2" cellpadding="0" cellspacing="0">
    <tbody>
    <tr>
      <td class="Col-Generic2NArea4"> <looknFeelArea:looknFeelArea area="Generic2NArea4" /> </td>
      <td class="Col-Generic2NArea5"> <looknFeelArea:looknFeelArea area="Generic2NArea5" /> </td>
      <td class="Col-Generic2NArea6"> <looknFeelArea:looknFeelArea area="Generic2NArea6" /> </td>
    </tr>
    <tr>
    	<td colspan="3">

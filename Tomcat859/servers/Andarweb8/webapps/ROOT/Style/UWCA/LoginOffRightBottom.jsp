...
<%
	...
	if (areaType == null)
		areaType = "None";
%>
<!-- /Style/UWCA/LoginOffRightBottom.jsp -->
		...
		<div class="col-md-3 RightSide Col-UWCA1LArea5">
			<looknFeelArea:looknFeelArea area="UWCA1LArea5" />
		</div>
	</div>
...
<div class="container">
	<div class="row">
		...
		<div class="UWCABottomContent">
			<div class="row">
				<div class="col-sm-12 Col-UWCA1LArea6">
					<looknFeelArea:looknFeelArea area="UWCA1LArea6" />
				</div>
			</div>
			<div class="row">
				<div class="col-sm-8 Col-UWCA1LArea7">
					<looknFeelArea:looknFeelArea area="UWCA1LArea7" />
				</div>
				<div class="col-sm-4 Col-UWCA1LArea8">
					<looknFeelArea:looknFeelArea area="UWCA1LArea8" />
				</div>
			</div>
		</div>
		</div>

...
<!-- /Style/UWCA/PageRightBottom.jsp -->
		...
		<div class="col-md-3 RightSide Col-UWCA1PArea5">
			<looknFeelArea:looknFeelArea area="UWCA1PArea5" />
		</div>
	</div>
...
<div class="container">
	<div class="row">
		...
		<div class="UWCABottomContent">
			<div class="row">
				<div class="col-sm-12 Col-UWCA1PArea6">
					<looknFeelArea:looknFeelArea area="UWCA1PArea6" />
				</div>
			</div>
			<div class="row">
				<div class="col-sm-8 Col-UWCA1PArea7">
					<looknFeelArea:looknFeelArea area="UWCA1PArea7" />
				</div>
				<div class="col-sm-4 Col-UWCA1PArea8">
					<looknFeelArea:looknFeelArea area="UWCA1PArea8" />
				</div>
			</div>
		</div>
		</div>

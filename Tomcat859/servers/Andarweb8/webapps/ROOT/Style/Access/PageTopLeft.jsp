	...
	<header>
		<div id="head">
			<nav id="top-nav" class="container">
				<div class="row">
					<div class="col-md-4">
                        <looknFeelArea:looknFeelArea area="Access_International-P-header-logo" />
                    </div>
					<div class="col-md-8">
                        <a role="button" id="mobileToggle" class="" type="button" data-toggle="collapse" data-target="#mobileMenu" aria-expanded="false" aria-controls="mobileMenu"><i class="fa fa-bars" alt="Toggle Menu"></i></a>
                        <div class="collapse" id="mobileMenu">
                            <looknFeelArea:looknFeelArea area="Access_International-P-header-topnav" />
                        </div>
					</div>
				</div>
			</nav>
